  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6">
        ...
        {/* Payment & Pricing Section - Designed based on 20E9227D-49BA-4282-89F5-4FC582CA8CD2_1_105_c.jpeg */}
        <section className="mb-12">
          <Card className="shadow-lg">
            <CardHeader>
        ...
        {/* Recording Types Section - Designed based on 4E0E934D-8341-411D-A9B7-64D72080FE0B_1_105_c.jpeg */}
        <section className="mb-12">
          <Card className="shadow-lg">
            <CardHeader>
