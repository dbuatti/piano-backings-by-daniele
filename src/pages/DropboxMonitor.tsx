    ...
    <div className="min-h-screen bg-gradient-to-b from-[#D1AAF2] to-[#F1E14F]/30">
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 tracking-tight text-[#1C0357]">Dropbox Connection Monitor</h1>
          <p className="text-xl md:text-2xl font-light text-[#1C0357]/90">Test and monitor your Dropbox integration</p>
        </div>
